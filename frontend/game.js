(function () {
  ...
  const MENTOR = {
    ...
    stage: {
      ...
      publishing: "🧾 محطة النشر: لنجهّز مخطوطتك وفق متطلبات المجلات الرصينة — من الملخّص إلى تضارب المصالح ومساهمات المؤلفين.",
      submission: "📤 محطة الإرسال: لنعبر 'الصندوق الأسود' — من رفع البحث ورقم التتبّع حتى منحه الـDOI ونشره.",
    },
